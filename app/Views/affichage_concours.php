        ...
        <tbody>
          ...
          if (!empty($concours) && is_array($concours)) {
            ...
            foreach ($concours as $c) {
              ...
              echo "</td>";
              echo "<td>";
              echo "<a href='https://obiwan.univ-brest.fr/~e22105002/index.php/concours/afficher/" . $c["con_id"] . "'> <img src='" . base_url() . "icons/loupe.png' width='25'> </a>";
              echo "</td>";
              if ($c["phase"] == 'A venir') {
                echo "<td></td>";
              }
              ...
              if ($c["phase"] == 'Finale') {
                echo "<td>";
                echo "<a href='https://obiwan.univ-brest.fr/~e22105002/index.php/concours/selectionner/" . $c["con_id"] . "'> <img src='" . base_url() . "icons/selection.png' width='25'> </a>";
                echo "</td>";
              }
              if ($c["phase"] == 'Terminé') {
                echo "<td>";
